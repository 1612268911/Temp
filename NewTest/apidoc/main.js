...
require([
    ...
    $('.sidenav').find('a').on('click', function(e) {
        ...
        if ($(id).length > 0)
            $('templates,body').animate({ scrollTop: parseInt($(id).offset().top) }, 400);
    ...
    if(window.location.hash) {
        ...
        if ($(id).length > 0)
            $('templates,body').animate({ scrollTop: parseInt($(id).offset().top) }, 0);
    }
    ...
    if ($.urlParam('compare')) {
        ...
        if (window.location.hash) {
            var id = window.location.hash;
            $('templates,body').animate({ scrollTop: parseInt($(id).offset().top) - 18 }, 0);
        }
    }
