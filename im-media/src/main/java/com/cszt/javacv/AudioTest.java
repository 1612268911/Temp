 ...
 * description:  录制视频/音频 -> e:/record.flv
 */
public class AudioTest {
    ...
    public static void recordWebcamAndMicrophone(int WEBCAM_DEVICE_INDEX, int AUDIO_DEVICE_INDEX, String outputFile,
                                                 int captureWidth, int captureHeight, int FRAME_RATE) throws FrameGrabber.Exception {
        long startTime = 0;
        long videoTS = 0;
        /**
    ...
    public static void main(String[] args) throws FileNotFoundException, FrameGrabber.Exception {
        ...
        String outputFile = "rtmp://192.168.138.128:1935/hls/record";
        int captureWidth = 400;
        int captureHeight = 300;
        recordWebcamAndMicrophone(WEBCAM_DEVICE_INDEX, AUDIO_DEVICE_INDEX, outputFile, captureWidth, captureHeight, FRAME_RATE);
    }
}